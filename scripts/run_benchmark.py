"""
Run the LinkGround evaluation benchmark against a local API instance.

Measures continuous groundedness and authority-weighted trust for each
dataset statement using one or more local Ollama analyst models.
"""
